...
Vtop::Vtop(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , i_clock{vlSymsp->TOP.i_clock}
    , i_reset{vlSymsp->TOP.i_reset}
    , o_error{vlSymsp->TOP.o_error}
    , o_rom_ready{vlSymsp->TOP.o_rom_ready}
    , o_data_rw{vlSymsp->TOP.o_data_rw}
    , o_data_rw_strobe{vlSymsp->TOP.o_data_rw_strobe}
    , i_instruction{vlSymsp->TOP.i_instruction}
    , o_instruction_address{vlSymsp->TOP.o_instruction_address}
    , o_data{vlSymsp->TOP.o_data}
    , i_data{vlSymsp->TOP.i_data}
    , o_data_address{vlSymsp->TOP.o_data_address}
    , rootp{&(vlSymsp->TOP)}
{
